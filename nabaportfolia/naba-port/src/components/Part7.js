    ...
    return (
        <div className="w-[90%] m-auto flex flex-col gap-[48px]  h-max rounded-[20px] py-[96px]">
            <div className="flex items-center flex-col gap-[16px]">
                ...
                <div className="flex ">
                    <div className="flex m-auto items-center justify-center">What’s next? Feel free to reach out to me if you're looking for a developer, have a query, or simply want to connect.</div>
                </div>
            </div>
            <div className="flex flex-col items-center">
                <div className="flex gap-[8px] items-center">
                    <div><BiLogoGmail className="w-[32px] h-[32px] text-gray-400	" /></div>
                    <div className="font-semibold text-[36px]">tom@pinecone.mn</div>
                    <div><FaRegCopy className="w-[32px] h-[32px] text-gray-400	" /></div>
                </div>
                <div className="flex gap-[8px] items-center">
                    <div><FaPhone className="w-[32px] h-[32px] text-gray-400	" /></div>
