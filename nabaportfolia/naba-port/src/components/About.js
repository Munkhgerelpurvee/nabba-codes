      ...
      <div className="w-[90%] m-auto flex flex-col gap-[48px]  h-max rounded-[20px] py-[96px]">
        ...
        <div className="flex flex-col lg:flex lg:flex-row ">
          <div className="flex flex-1 items-center justify-center">
            <img className="w-[360px] h-[360px] rounded-[20px]" src="/me.jpg" />
          </div>
          <div className="flex-1 gap-[16px] flex flex-col ">
            ...
            <ul>
              <li className="flex gap-[8px] items-center"> <FaHandPointRight /> B.E. in Computer Engineering</li>
              <li className="flex gap-[8px] items-center"> <FaHandPointRight /> Avid learner</li>
              <li className="flex gap-[8px] items-center"> <FaHandPointRight /> Full time freelancer</li>
            </ul>
          </div>
        </div>
      </div>
