...
export const Contact = () => {
  return (
    <div className="flex flex-col lg:w-[1220px] w-[390px] items-center justify-between m-auto pt-[68px] pb-[32px] gap-[30px]">
      ...
      <div className="flex flex-row w-[624px] gap-[50px]">
      ...
      <div className="bg-[#F6F6F7] w-[624px] flex flex-col rounded-xl gap-[20px] py-[16px] px-[32px]">
        ...
        <div className="flex gap-[28px]">
          ...
          <input
            ...
            className=" bg-[#FFFFFF] text-[#A1A1AA] text-[16px] px-[8px] flex-1 py-[8px]"
          ></input>
        </div>
        <div>
          <input
